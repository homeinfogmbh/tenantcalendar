...
2. Betrifft die Änderung Zweck, Schnittstellen, Deployment oder Abhängigkeiten
   (neue/entfernte DB-Tabellen/ORM-Modelle, WSGI-Routen/Endpoints, Console-Scripts, Python-Dependencies): zusätzlich `ARCHITECTURE.md` im Repo-Root aktualisieren, inkl.
